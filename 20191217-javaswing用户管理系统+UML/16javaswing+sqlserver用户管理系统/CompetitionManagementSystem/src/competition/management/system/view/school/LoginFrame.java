...
public class LoginFrame extends JFrame {
    ...
    public LoginFrame() {
        ...
        //textField_username.setText("C12343");
        //passwordField_password.setText("aaaaaa");
    }

    private void button1ActionPerformed(ActionEvent e) {
        try {
            SchoolAdmin schoolAdmin = schoolAdminDao.findByUsernameAndPassword(textField_username.getText(), String.copyValueOf(passwordField_password.getPassword()));
            LoginStatusUtil.SCHOOL_ADMIN_LOGGED_IN = schoolAdmin;
            this.setVisible(false);
            SchoolMainFrame schoolMainFrame = new SchoolMainFrame();
            schoolMainFrame.setExtendedState(JFrame.MAXIMIZED_BOTH);
            schoolMainFrame.setSchoolAdminDao(LoginStatusUtil.SCHOOL_ADMIN_LOGGED_IN);
    ...
    private void initComponents() {
        ...
        ResourceBundle bundle = ResourceBundle.getBundle("competition.management.system.view.school.LoginFrame");
        label1 = new JLabel();
        label2 = new JLabel();
        label3 = new JLabel();
