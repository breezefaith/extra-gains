...
public class ChangePasswordFrame extends JFrame {
    ...
    private void buttonChangeActionPerformed(ActionEvent e) {
        ResourceBundle bundle = ResourceBundle.getBundle("competition.management.system.view.member.ChangePasswordFrame");
        try {
            if (memberDao.changePassword(LoginStatusUtil.MEMBER_LOGGED_IN.getId(), String.copyValueOf(passwordField_new.getPassword()))) {
                LoginStatusUtil.MEMBER_LOGGED_IN.setPassword(String.copyValueOf(passwordField_new.getPassword()));
