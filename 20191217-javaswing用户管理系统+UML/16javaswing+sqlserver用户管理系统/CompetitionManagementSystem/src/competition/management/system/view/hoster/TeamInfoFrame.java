...
public class TeamInfoFrame extends JFrame {
    ...
    private void buildTable() {
        ResourceBundle bundle = ResourceBundle.getBundle("competition.management.system.view.hoster.TeamInfoFrame");
        try {
    ...
    private void button_membersInfoActionPerformed(ActionEvent e) {
        for (Member member : members) {
            ...
            personalInfoFrame.setHosterAdmin(hosterAdmin);
    ...
    private void button_prodInfoActionPerformed(ActionEvent e) {
        ...
        productInfoFrame.setHosterAdmin(hosterAdmin);
    ...
    private void thisWindowClosing(WindowEvent e) {
        if (this.hosterMainFrame != null) {
            hosterMainFrame.load();
            hosterMainFrame.setVisible(true);
        }
    }

    private void button_markActionPerformed(ActionEvent e) {
    ...
    private void initComponents() {
        ...
        button_update.setBounds(690, 125, 80, button_update.getPreferredSize().height);
        ...
        //---- button_mark ----
        button_mark.setText(bundle.getString("TeamInfoFrame.button_mark.text"));
        button_mark.addActionListener(e -> button_markActionPerformed(e));
        contentPane.add(button_mark);
        button_mark.setBounds(785, 125, 80, button_mark.getPreferredSize().height);
