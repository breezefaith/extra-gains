...
//localStorage.clear();
var movieNameArray = ["Clown", "El hoyo", "Midway", "Bruce Almighty", "Wreck-It Ralph", "Toy Story", "The Highwaymen", "Green Book", "The Shawshank Redemption", "The Blind Melody"];
var movieDirectorArray = ["Jon Watts", "Garde", "Roland Emmerich", "Tom Shadyac", "Ritchie Moore", "John Lasseter ", "John Lee Hancock", "Peter Farrelly", "Frank Darabont", "Sriram Raghavan"];
var movieYearArray = ["2014", "2019", "2019", "2003", "2012", "1995", "2019", "2018", "1994", "2019"];
var movieTypeArray = ["Horror", "Thriller", "Drama", "Comedy", "Comedy", "Comedy", "Thriller", "Drama", "Drama", "Drama"];
var movieNotesArray = ["good movie", "Have imagination", "Historical adaptation", "Very interesting", "Animated comedy", "Animated comedy", "Plot stimulation", "It is worth pondering", "great movie", "The episode is good"];
...
/*---Movie list--- */
function showList(movieNameArray) {
    var theText = "";
    ...
    document.getElementById("div2").innerHTML = theText;
...
/*Add movie data */
function showAdd() {
    document.getElementById("div2").innerHTML = "Name: <form name='mform'><input name='mname'><br>Director: <br><input name='mdirector'><br>Type: <br><input name='mtype'><br>Year: <br><input name='myear'><br>Notes: <br><input name='mnotes'><br><br><a onclick = \"addMovie(document.forms['mform']['mname'].value,document.forms['mform']['mdirector'].value,document.forms['mform']['mtype'].value,document.forms['mform']['myear'].value,document.forms['mform']['mnotes'].value)\">---Submit---</a></form>";
    document.getElementById("div3").innerHTML = "";
}
function addMovie(name, director, type, year, notes) {
    if (name != null && director != null && type != null && year != null && notes != null && name != "" && director != "" && type != "" && year != "" && notes != "") {
        ...
        document.getElementById("div3").innerHTML = "You need to fill in all!";
    }
}
/*View movie details */
function showDetails(p) {
    ...
    for (var i = 0; i < movieNameArray.length; i++) {
        //alert(n);
        if (movieNameArray[i] + " " == n) {
            document.getElementById("div2").innerHTML = "<p ><a onclick = 'showNameEdit(" + i + ")'> #Edit# </a> Name: " +
                movieNameArray[i] + "</p>" +
...
// ---movie Name---
function showNameEdit(i) {
    document.getElementById("div2").innerHTML = "<form name='mform'><input name='mname'><a onclick = \"editName(" + i + ",document.forms['mform']['mname'].value)\">---Submit---</a></form>";
}
function editName(i, n) {
    if (n !== null && n !== "") {
        movieNameArray[i] = n;
        saveMovie();
        showList(movieNameArray);
...
//---Director---
function showDirectorEdit(i) {
    document.getElementById("div2").innerHTML = "<form name='mform'><input name='mname'><a onclick = \"editDirector(" + i + ",document.forms['mform']['mname'].value)\">---Submit---</a></form>";
}
function editDirector(i, n) {
    if (n !== null && n !== "") {
...
//---Year---
function showYearEdit(i) {
    document.getElementById("div2").innerHTML = "<form name='mform'><input name='mname'><a onclick = \"editYear(" + i + ",document.forms['mform']['mname'].value)\">---Submit---</a></form>";
}
function editYear(i, n) {
    if (n !== null && n !== "") {
        movieYearArray[i] = n;
        saveMovie();
        showList(movieNameArray);
...
function showTypeEdit(i) {
    document.getElementById("div2").innerHTML = "<form name='mform'><input name='mname'><a onclick = \"editType(" + i + ",document.forms['mform']['mname'].value)\">---Submit---</a></form>";
}
function editType(i, n) {
    if (n !== null && n !== "") {
        movieTypeArray[i] = n;
        saveMovie();
        showList(movieNameArray);
...
//---Notes---
function showNotesEdit(i) {
    document.getElementById("div2").innerHTML = "<form name='mform'><input name='mname'><a onclick = \"editNotes(" + i + ",document.forms['mform']['mname'].value)\">---Submit---</a></form>";
}
function editNotes(i, n) {
    if (n !== null && n !== "") {
        movieNotesArray[i] = n;
        saveMovie();
        showList(movieNameArray);
...
/*Find movie*/
function showSelect() {
    document.getElementById("div2").innerHTML = "<p>Enter the name of the movie you want to find: </p><form name='mform'><input name='mname'> <a onclick = \"selectMovie(document.forms['mform']['mname'].value)\">---Search---</a></form>";
    document.getElementById("div3").innerHTML = "";
}
function selectMovie(n) {
    if (n !== null && n !== "") {
        ...
        document.getElementById("div3").innerHTML = theText;
    }
    else {
        document.getElementById("div3").innerHTML = "Please fill in the movie name!";
    }
}
