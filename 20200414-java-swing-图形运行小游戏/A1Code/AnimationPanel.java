...
public class AnimationPanel extends JComponent implements Runnable {
    ...
    protected void createNewShape(int x, int y) {
        ...
        switch (currentShapeType) {
            case 0: {
                //shapes.add( ... ) //create a new MovingRectangle and add it to the list
                break;
            }
       }
    }
    ...
    public String getCurrentMessage() { return ""; } //complete this
    public void setCurrentMessage(String s) {} //complete this
