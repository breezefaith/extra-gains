...
//        graph.traverse();
        ...
        JavaPairRDD<Integer, Tuple3<String, Integer, String>> outputRdd = context.parallelizePairs(graph.getUnsortedTupleResult());

        //step8: Sort by distance and get the formatted tuple list then save to file
        JavaRDD<Tuple3<String, Integer, String>> lastRdd = outputRdd.sortByKey().values();
