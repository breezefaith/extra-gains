...
ALTER TABLE "HAS_ACCOUNT" ADD FOREIGN KEY ("ACCOUNT_NUM") REFERENCES "CHECKING_ACCOUNTS" ("ACCOUNT_NUM") NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "HAS_ACCOUNT" ADD FOREIGN KEY ("ACCOUNT_NUM") REFERENCES "SAVINGS_ACCOUNTS" ("ACCOUNT_NUM") NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
ALTER TABLE "HAS_ACCOUNT" ADD FOREIGN KEY ("ACCOUNT_NUM") REFERENCES "LOAN_ACCOUNTS" ("ACCOUNT_NUM") NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
