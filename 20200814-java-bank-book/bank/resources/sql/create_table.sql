...
CREATE TRIGGER "DEVUSER"."BEFORE_ADD_CHECKING_ACCOUNT" BEFORE INSERT ON "DEVUSER"."CHECKING_ACCOUNTS" REFERENCING OLD AS "OLD" NEW AS "NEW" FOR EACH ROW
BEGIN
  :NEW."date_opened" := sysdate;
END;
/

CREATE TRIGGER "DEVUSER"."BEFORE_ADD_LOAN_ACCOUNTS" BEFORE INSERT ON "DEVUSER"."LOAN_ACCOUNTS" REFERENCING OLD AS "OLD" NEW AS "NEW" FOR EACH ROW
BEGIN
  :NEW."date_opened" := sysdate;
END;
/

CREATE TRIGGER "DEVUSER"."BEFORE_ADD_SAVINGS_ACCOUNTS" BEFORE INSERT ON "DEVUSER"."SAVINGS_ACCOUNTS" REFERENCING OLD AS "OLD" NEW AS "NEW" FOR EACH ROW
BEGIN
  :NEW."date_opened" := sysdate;
END;
/
