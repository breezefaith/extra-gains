...
/*
 * AbstractFitnessQuestions.java  	1.0  10/04/2020
 *
...
public abstract class AbstractFitnessQuestions {
    ...
    /**
     * getLowestNumberOfStepsParticipants method - Answer to Q15
     * 1 - using the List of fitness trackers, each one is a Tracker object
     * 2 - and then returns list of participant/s with the lowest number of steps
     *
     * @return Set of participant/s IDs with the lowest number of steps.
     */
    public abstract Set<String> getLowestNumberOfStepsParticipants();
    
    /**
     * getHighestWalkedDistanceParticipants method - Answer to Q16
     * 1 - using the List of fitness trackers, each one is a Tracker object
    ...
    /**
     * getLowestWalkedDistanceParticipants method - Answer to Q17
     * 1 - using the List of fitness trackers, each one is a Tracker object
     * 2 - and then returns list of participant/s with the lowest walked distance
     *
     * @return Set of participant/s IDs with the lowest walked distance.
     */
    public abstract Set<String> getLowestWalkedDistanceParticipants();
    
    /**
     * getDistanceMCountForFT5 method - Answer to Q18
     * 1 - using the List of fitness trackers, each one is a Tracker object
    ...
    /**
     * getAvgHRAboveGlobalParticipants method - Answer to Q19
     * 1 - using the List of fitness trackers, each one is a Tracker object
    ...
    /**
     * getAvgHRBelowGlobalParticipants method - Answer to Q20
     * 1 - using the List of fitness trackers, each one is a Tracker object
     * 2 - and then returns list of participant/s with an average individual participant 
