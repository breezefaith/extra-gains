...
public class TreeTest {
	...
	public void sumAtDepthTest3() {
		...
		bt.insertNode(6);
		bt.insertNode(22);
		Integer sum = TreeFunctions.sumAtDepthIterative(bt, 9);
		assertEquals(Integer.valueOf(0), sum);
		// Student: try at different depths!!
	}

	@Test
	public void sumAtDepthTest4() {
		LinkedBinaryTree<Integer> bt = new LinkedBinaryTree<>();
		bt.insertNode(50);
		bt.insertNode(2);
		bt.insertNode(34);
		...
		bt.insertNode(6);
		bt.insertNode(22);
		Integer sum = TreeFunctions.sumAtDepthRecursive(bt, 9);
		assertEquals(Integer.valueOf(0), sum);
		// Student: try at different depths!!
	}
	...
	@Test
	public void reduceAtDepthTest3() {
		LinkedBinaryTree<Integer> bt = new LinkedBinaryTree<>();
		bt.insertNode(50);
		bt.insertNode(2);
		bt.insertNode(34);
		...
		bt.insertNode(6);
		bt.insertNode(22);
		int sum = bt.reduceAtDepthIterative(9, new IntegerSum(), 0);
		assertEquals(0, sum);
		// Student: try at different depths!!
	}

	@Test
	public void reduceAtDepthTest4() {
		LinkedBinaryTree<Integer> bt = new LinkedBinaryTree<>();
		bt.insertNode(50);
		bt.insertNode(2);
		bt.insertNode(34);
		...
		bt.insertNode(6);
		bt.insertNode(22);
		int sum = bt.reduceAtDepthRecursive(9, new IntegerSum(), 0);
		assertEquals(0, sum);
		// Student: try at different depths!!
	}
