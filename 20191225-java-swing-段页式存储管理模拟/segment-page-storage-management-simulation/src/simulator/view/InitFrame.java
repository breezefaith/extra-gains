...
public class InitFrame extends JFrame {
    ...
    private void buttonStartActionPerformed(ActionEvent e) {
        try {
            ...
            //todo 删除代码
            manager.createProcess(3, new int[]{100, 100, 100});
            manager.createProcess(2, new int[]{200, 50});
            manager.createProcess(1, new int[]{100});
    ...
    public void load() {
        textFieldPageNum.setText("100");
        textFieldFrameSize.setText("10");
        textFieldSegmentTableLength.setText("20");
    }
